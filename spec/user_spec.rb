...
describe "User session" do
  ...
  available_methods = CLIENT.methods(false).sort - [:comments_add, :comments_plus, :comments_minus, :comments_delete, :comments_edit, :link_bury, :add_new, :execute, :replace_url, :login, :observatory_entries_comments, :related_add]
